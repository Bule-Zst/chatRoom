...
<script>
	...
	// 	var nameReturn1 = document.getElementById('nameReturn1');
	// 	var nameReturn2 = document.getElementById('nameReturn2');
	// 	nameReturn1.style.display = 'none';
	// 	nameReturn2.style.display = 'none';
	// 	nameReturn3.style.display = 'inline';
	// 	var xhr = new XMLHttpRequest();
	...
	// 				}
	// 				else{
	// 					hint.innerHTML = "register success,"
	// 				}
	// 				nameReturn1.style.display = 'inline';
	// 				nameReturn3.style.display = 'none';
	// 				countDown(); 
	...
	// 			else{
	// 				if( language == 'chinese' ){
	// 					nameReturn2.innerHTML = '用户名已存在';
	// 				}
	// 				else{
	// 					nameReturn2.innerHTML = 'account number is existed';
	// 				}
	// 				nameReturn2.style.display = 'inline';
	// 				nameReturn3.style.display = 'none';
	// 			}
